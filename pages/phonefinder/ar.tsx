    ...
    return (
        <div className='mx-10 ar'>
            <div
                ...
                className='text-gray-200 lg:text-gray-200 flex bg-[bottom] bg-[length:1269px_450px] lg:h-72 rounded-xl mt-10 pt-20 pb-3 lg:py-10 px-3 lg:px-10 text-2xl lg:text-5xl font-bold font-serif'>
                <p className='mt-auto'>ابحث عن تليفون</p>
            </div>
