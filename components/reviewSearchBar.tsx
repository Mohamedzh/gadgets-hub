...
export default function SearchBar({ brands }: { brands: { name: string }[] }) {
    ...
    return (
        <Combobox as="div" className='w-max lg:mx-10 mx-5 my-5' value={selectedPerson} onChange={setSelectedPerson}>
            <Combobox.Label className="block font-medium text-gray-200">Search reviews by Brand</Combobox.Label>
