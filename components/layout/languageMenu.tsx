      ...
      <Menu as="div" className="relative inline-block text-left">
        <div>
          <Menu.Button
            ...
            className={`${router.locale === "ar" ? "w-[120px]" : ""} mt-2.5 inline-flex w-full justify-center rounded-md bg-gray-800 bg-opacity-20 px-4 py-2 font-medium text-white hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 hover:bg-gray-500`}
          >
            <Image
              width={25}
              height={25}
              ...
              alt="language flag"
              className={`${router.locale === "ar" ? "order-1": "order-2"} min-w-[25px]`}
            ></Image>
            <span className={`${router.locale === "en" ? "order-1": "order-2"} mx-1`}>{t("lang")}</span>
            {/* <ChevronDownIcon
