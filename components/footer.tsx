    ...
    return (
        <footer className="bg-gray-800" aria-labelledby="footer-heading">
            ...
            <div className="mx-auto max-w-7xl py-4 px-4 sm:px-6 lg:py-4 lg:px-8">
                ...
                {/* </div> */}
                <div className=" pt-8 md:flex md:items-center md:justify-between flex flex-col">
                    <div className="flex space-x-6 md:order-2 my-3">
                    ...
                    <p className="mt-8 text-base text-gray-400 text-center md:mt-0">
                        &copy; 2022 Tech Advisor All rights reserved.
                    </p>
                    <p className="text-gray-400 text-sm mt-5 place-self-start md:order-3">
                        Disclaimer: Data obtained from <Link href='https://www.gsmarena.com'><a>www.gsmarena.com</a></Link>
                    </p>
                </div>
            </div>
        </footer>
